...
wasteGenerators: {
  ...
  description:
    "कचरा उत्पादकों की भागीदारी, कचरा योगदान, गतिविधि, निगरानी और संग्रह प्रदर्शन का अवलोकन।",
  ...
  gvp: {
    title: "GVP उत्पादन रुझान",

    loading: "GVP डेटा लोड हो रहा है...",

    empty:
      "चयनित तिथि और डिवीजन के लिए कोई GVP डेटा उपलब्ध नहीं है।",

    error: "GVP रुझान लोड करने में असमर्थ",
  ...
  map: {
    ...
    noBoundary:
      "इस चयन के लिए वार्ड की सीमा उपलब्ध नहीं है",

    noTelemetry:
      "इस तिथि के लिए कोई टेलीमेट्री बिंदु उपलब्ध नहीं है",
    ...
    summary: {
      ...
      telemetryCoordinates:
        "टेलीमेट्री निर्देशांक",

      vehicleTables: "वाहन तालिकाएँ",
    ...
    errors: {
      loadWardMap:
        "चयनित वार्ड का मानचित्र लोड करने में असमर्थ।",
    },

    /* ================= TOOLTIP ================= */

    tooltip: {
      collectionVehicle: "संग्रह वाहन",
...
users: {
  ...
  footer:
    "© 2026 SEWAC. सर्वाधिकार सुरक्षित।",
},
...
cityOverviewMap: {
  ...
  cityOverview: "शहर का अवलोकन मानचित्र",

  routeMaps: "रूट मानचित्र",

  liveMaps: "लाइव मानचित्र",
  ...
  customerGrievances: {
    title: "ग्राहक शिकायतें",

    loading:
      "ग्राहक शिकायतें लोड की जा रही हैं...",

    error:
      "ग्राहक शिकायतें लोड नहीं की जा सकीं।",
  ...
  loadingDivisions:
    "डिवीजन लोड किए जा रहे हैं...",

  loadingWards:
    "वार्ड लोड किए जा रहे हैं...",
  ...
  loadingDivisionsFor:
    "इसके लिए डिवीजन लोड किए जा रहे हैं",

  loadingWardsFor:
    "इसके लिए वार्ड लोड किए जा रहे हैं",
  ...
  loadingPlants:
    "संयंत्र स्थान लोड किए जा रहे हैं...",

  unableLoadPlants:
    "संयंत्र लोड नहीं किए जा सके",

  changeMapView:
    "मानचित्र दृश्य बदलें",

  loading:
    "शहर का मानचित्र लोड किया जा रहा है...",
},
...
users: {
  ...
  admin: {
    title: "एडमिन स्तर 1 उपयोगकर्ता",

    description:
      "अन्य एडमिन स्तर 1 उपयोगकर्ताओं को प्रबंधित करें जिनके पास सिस्टम का पूर्ण एक्सेस है।",

    searchPlaceholder:
      "नाम, ईमेल या फोन से खोजें...",

    addButton:
      "एडमिन जोड़ें",

    loading:
      "एडमिन स्तर 1 उपयोगकर्ताओं को लोड किया जा रहा है...",

    empty:
      "कोई एडमिन स्तर 1 उपयोगकर्ता नहीं मिला।",

    errors: {
      fetchFailed:
        "एडमिन स्तर 1 उपयोगकर्ताओं को प्राप्त करने में विफल।",
    },
  ...
  contractor: {
    title: "कॉन्ट्रैक्टर उपयोगकर्ता",

    description:
      "कॉन्ट्रैक्टर खातों और उनकी एक्सेस अनुमतियों को प्रबंधित करें।",
    ...
    loading:
      "कॉन्ट्रैक्टर उपयोगकर्ताओं को लोड किया जा रहा है...",

    empty:
      "कोई कॉन्ट्रैक्टर उपयोगकर्ता नहीं मिला।",

    errors: {
      fetchFailed:
        "कॉन्ट्रैक्टर उपयोगकर्ताओं को प्राप्त करने में विफल।",
    },
    ...
    modals: {
      addTitle: "कॉन्ट्रैक्टर जोड़ें",
      editTitle: "कॉन्ट्रैक्टर संपादित करें",
    },
  },
