...
users: {
  admin: {
    title: "ಆಡ್ಮಿನ್ ಹಂತ 1 ಬಳಕೆದಾರರು",
    description: "ಸಿಸ್ಟಮ್‌ಗೆ ಸಂಪೂರ್ಣ ಪ್ರವೇಶ ಹೊಂದಿರುವ ಇತರ ಆಡ್ಮಿನ್ ಹಂತ 1 ಬಳಕೆದಾರರನ್ನು ನಿರ್ವಹಿಸಿ.",
    searchPlaceholder: "ಹೆಸರು, ಇಮೇಲ್ ಅಥವಾ ಫೋನ್ ಮೂಲಕ ಹುಡುಕಿ",
    addButton: "ಆಡ್ಮಿನ್ ಸೇರಿಸಿ",
  },

  contractor: {
    title: "ಕಾಂಟ್ರಾಕ್ಟರ್ ಬಳಕೆದಾರರು",
    description: "ಕಾಂಟ್ರಾಕ್ಟರ್ ಬಳಕೆದಾರರು ಮತ್ತು ಅವರ ಸಿಸ್ಟಮ್ ಪ್ರವೇಶವನ್ನು ನಿರ್ವಹಿಸಿ.",
    searchPlaceholder: "ಹೆಸರು, ಇಮೇಲ್ ಅಥವಾ ಫೋನ್ ಮೂಲಕ ಹುಡುಕಿ",
    addButton: "ಕಾಂಟ್ರಾಕ್ಟರ್ ಸೇರಿಸಿ",
  },
