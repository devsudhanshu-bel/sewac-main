# kn.js Translation Documentation

## 1. File Overview

**File:** `src/i18n/translations/kn.js`  
**Language:** Kannada  
**Language Code:** `kn`

This file contains the frontend translation dictionary for the `Kannada` interface.
...
The object is imported by `LanguageContext.jsx` and registered under the `kn` language code.
...
The `kn.js` file is the localized text catalog for the Kannada interface.
