# en.js Translation Documentation

## 1. File Overview

**File:** `src/i18n/translations/en.js`  
**Language:** English  
**Language Code:** `en`

This file contains the frontend translation dictionary for the `English` interface.
...
The object is imported by `LanguageContext.jsx` and registered under the `en` language code.
...
The `en.js` file is the localized text catalog for the English interface.
