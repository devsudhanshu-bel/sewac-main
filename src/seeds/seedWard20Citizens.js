...
// =====================================================
// WARD 20 CITIZEN SIMULATION SEED
// =====================================================
...
// =====================================================
//
// Ward 20 gets its own synthetic phone range.
// =====================================================
...
// lat -> numeric
//
// Number(...) ensures that PostgreSQL receives
// a numeric value instead of the string produced
// by toFixed().
// =====================================================
...
// =====================================================
//
// One SQL query inserts 100 citizens.
//
...
async function seed() {
  ...
  console.log(
    "SEWAC WARD 20 CITIZEN SIMULATION SEED"
  );
